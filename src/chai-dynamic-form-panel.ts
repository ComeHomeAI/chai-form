...
export class DynamicControlPanel extends LitElement {
  ...
  applyStyles() {
    ...
    const bgColor = (
      this.shadowRoot?.getElementById('bgColor') as HTMLInputElement
    ).value;
    const textColor = (
      this.shadowRoot?.getElementById('textColor') as HTMLInputElement
    ).value;
    const fontSize =
      (this.shadowRoot?.getElementById('fontSize') as HTMLInputElement).value +
      'px';
    const width =
      (this.shadowRoot?.getElementById('width') as HTMLInputElement).value +
      'px';

    const height = (
      this.shadowRoot?.getElementById('height') as HTMLInputElement
    ).value;

    const applyToComponent = (
      this.shadowRoot?.getElementById('applyToComponent') as HTMLInputElement
    ).checked;
    const applyToElements = (
      this.shadowRoot?.getElementById('applyToElements') as HTMLInputElement
    ).checked;
  ...
  addElement() {
    ...
    const elementType = (
      this.shadowRoot?.getElementById('elementType') as HTMLSelectElement
    ).value;
    const elementPlaceholder = (
      this.shadowRoot?.getElementById('elementPlaceholder') as HTMLInputElement
    ).value;
    const elementId = (
      this.shadowRoot?.getElementById('elementId') as HTMLInputElement
    ).value;
    const elementName = (
      this.shadowRoot?.getElementById('elementName') as HTMLInputElement
    ).value;
